...
public class SGIPDeliverMessage extends SGIPMessage
{
    ...
    public byte[] getMsgId() {
        byte[] msgId = new byte[12];
        System.arraycopy(getBytes(), 0, msgId, 0, 12);
        return msgId;
    }
    ...
    public String toString()
    {
        ...
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MsgId=").append(TypeConvert.bytesToHexString(getMsgId(), 12))));

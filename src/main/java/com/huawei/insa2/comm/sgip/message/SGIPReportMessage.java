...
public class SGIPReportMessage extends SGIPMessage
{
    ...
    public String toString()
    {
        ...
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",SubmitSequenceNumber=").append(TypeConvert.byte2int(getSubmitSequenceNumber(), 8))));
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MsgId=").append(TypeConvert.bytesToHexString(getSubmitSequenceNumber(), 12))));

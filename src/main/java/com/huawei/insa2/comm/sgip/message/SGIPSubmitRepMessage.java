...
public class SGIPSubmitRepMessage extends SGIPMessage
{
    ...
    public String toString()
    {
        ...
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append("MsgId=").append(TypeConvert.bytesToHexString(getBytes(), 12))));

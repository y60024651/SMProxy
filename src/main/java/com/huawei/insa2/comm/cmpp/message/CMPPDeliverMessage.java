...
public class CMPPDeliverMessage extends CMPPMessage
{
    ...
    public String toString()
    {
        ...
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MsgId=").append(TypeConvert.byte2long(getMsgId()))));
        ...
        {
            tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",Msg_Content.MsgId=").append(TypeConvert.byte2long(getStatusMsgId()))));
            tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",Msg_Content.Stat=").append(getStat())));
            tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",Msg_Content.SubmitTime=").append(getSubmitTime())));
            tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",Msg_Content.DoneTime=").append(getDoneTime())));
            tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",Msg_Content.DestTerminalId=").append(getDestTerminalId())));
            tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",Msg_Content.SMSCSequence=").append(getSMSCSequence())));
        } else
        {
            try {
                // UCS2编码或GBK编码
                String msgContent = 8 == getMsgFmt() ? new String(getMsgContent(), "ISO-10646-UCS-2") : 15 == getMsgFmt() ? new String(getMsgContent(), "GBK") : new String(getMsgContent());
                tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MsgContent=").append(msgContent)));
